...
//           {/* LEFT SIDE */}
//           <div className="space-y-8 pt-8">
//             <div className="inline-block px-4 py-1.5 rounded-full bg-gradient-to-r from-indigo-500 via-purple-600 to-pink-500 text-sm font-semibold shadow-lg">
//               Beta • Web3
//             </div>

//             <h1 className="text-[4.6rem] md:text-[5.2rem] font-extrabold leading-[1.05] float-slow">
//               DevLance
//             </h1>
